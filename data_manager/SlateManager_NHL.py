import math
from projection_providers.NHL_Projections import NHL_Projections
from Optimizer import NHL_Optimizer
import random
import datetime
import utils
import statistics
...
def optimize_slate(slate_path, template_path):
  projections = NHL_Projections(download_folder + slate_path, "NHL")
...
if __name__ == "__main__":
  ...
  slate_path = "FanDuel-NHL-2022 ET-10 ET-11 ET-81550-players-list.csv"
  template_path = "FanDuel-NHL-2022-10-11-81550-entries-upload-template.csv"
