import math
from projection_providers.MLB_projections import MLBProjections
...
if __name__ == "__main__":
  ...
  slate_path = "FanDuel-MLB-2022 ET-10 ET-08 ET-81598-players-list.csv"
  template_path = "FanDuel-MLB-2022-10-08-81598-entries-upload-template.csv"
  teams_to_remove = []


  projections = MLBProjections(download_folder + slate_path, "MLB")
  ...
  player_id_to_name, _, _, name_to_player_id, first_line, entries, to_remove, player_id_to_fd_name = parse_upload_template(download_folder + template_path, [], '', 0) #MLB
  ...
  rosters = optimizer.optimize(by_position, 100000)
