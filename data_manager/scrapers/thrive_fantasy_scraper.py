...
class TFScraper:
    ...
    def run(self):
        headers = {
            ...
            'token': 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhbWwiLCJhdWRpZW5jZSI6IklPUyIsInBhc3MiOiIkMmEkMTAkTUdyR2FQbzhvZW91aEwuSnRjeWtBdWMzVVk1d1RNeFNtVm1XbmJyUDdpR1YzejhRb3V5MTIiLCJjcmVhdGVkIjoxNjYyMjU4MzkxODIwLCJleHAiOjE2NjI4NjMxOTF9.cpfuuNHMvcLClfW9WM_XRVnsTPGiGAq9axiJttICgf610HUBA0S-ttSz00sj_Gkm5gJQcT31p_-GoYEgh4B2iA',
