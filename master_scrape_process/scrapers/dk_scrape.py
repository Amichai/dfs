...
def query_dk():
    ...
    target_categories = [4991, 5001, 9975]
    target_category_labels = [" Points", " Points + Assists + Rebounds", " Steals + Blocks", " Rebound", " Assists"]
    ...
    for i in range(len(target_categories)):
        ...
        time.sleep(0.5)
        response = requests.get('https://sportsbook.draftkings.com//sites/US-SB/api/v4/eventgroups/88670846/categories/583/subcategories/{}'.format(target_category), headers=headers, params=params)
        #5001, 9975
        # pts - 4991
        ...
        for category in categories:
            if category["offerCategoryId"] == 583:
        ...
        for offer in selected_subcategory['offerSubcategory']['offers']:
            for sub_offer in offer:
                for outcome in sub_offer["outcomes"]:
                    ...
                    # if category == "Points":
                    #     if name in seen_names_points:
                    #         print("DK WARNING WE'VE SEEN THIS NAME BEFORE: {}".format(name))
                    #     seen_names_points.append(name)
                    ...
                    if not category in to_return[name]:
                        ...
                        try:
                            ...
                            over_odds = 1.0 / over_odds
                            under_odds = 1.0 / under_odds
                            ...
                            to_return[name][category] = str(line)
                        except:
                            print("PARSE ERROR. Deleting: {} {} {}".format(name, category, to_return[name][category]))
                            del to_return[name][category]
